...
- **feature phone bench**: Android Go 級 (Snapdragon 4xx / RAM 2GB) 実機で ed25519 verify スループット・batch 圧縮コストを測定し、§5.7.6 の想定値を検証。
